      ...
      .col-lg-10
        .cajon.color-primario.mb-4
          .row.justify-content-center.py-5
            .col-11  
              p La última milla es quizá el reto más relevante y desafiante en el desarrollo de la logística actual, todas las empresas de servicios postales y de transporte de mercancías deben desarrollar el proceso con especial cuidado y atención, deben buscar ser eficientes no solo, en tiempos sino, también en recursos y estos recursos son de índole humano, económico y de equipos dispuestos para la operación. 
